...
export default function Login() {
  ...
  return (
    <>
      <SEOHead
        title="Entrar — Dimension.Lab3D"
        description="Acesse sua conta na Dimension.Lab3D"
        canonical="/login"
      />
      ...
      <div className="min-h-screen flex items-center justify-center px-4 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="rounded-card border border-border bg-surface p-8 flex flex-col gap-6">
            <h1 className="text-xl font-semibold text-text-primary text-center">Entrar na conta</h1>
